...
|---|---|
| [Figures](./figures.md) | Per-figure subdirectories (`figures/<id>/<id>.{pdf,png,html,...}`), target-specific artifact resolution (PDF prefers `.pdf`, HTML prefers `.html`), automatic whitespace cropping on raster figures during build. |
...
| [Preview blocks](./preview-blocks.md) | `<!-- latex-builder:preview:begin hash=… -->` auto-generated markdown-renderable approximations of ```latex figures / tables / math, keyed by a hash of the source block. |
